...
| **[AhuraRTOS on STM32](stm32.md)** | **Everything STM32 in one page.** Three install routes - **[automatic](stm32.md#automatic---one-command)**, **[offline](stm32.md#offline---no-internet-on-the-machine)**, **[manual](stm32.md#manual---step-by-step)** with the exact CubeMX checkboxes - then **[the `st/stm32` package](stm32.md#the-soc-package)**. Verified end to end on the NUCLEO-H743ZI, H503RB and G431RB |
