...
| Page | What is in it |
|---|---|
| **[Installation](installation.md)** | The six-step procedure, for any vendor, IDE and build system. Get the source, copy three files, add them to the build, route the tick, check `PendSV`, boot. Ends with a build-error table |
