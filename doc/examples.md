...
| [`os_main_sem.c`](../examples/kernel/os_main_sem.c) | Producer/consumer over a counting semaphore: the consumer blocks in `os_sem_take` and wakes the moment a token appears | `SEM` | 1 |
