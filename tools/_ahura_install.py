...
tools/_platforms/. So piping a bootstrap straight into Python still works with nothing else on
...
tools/_platforms/<name>.py supplies the parts that do name a vendor - how to recognise the
