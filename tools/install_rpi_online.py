...
from install_common import (
    Fatal, SourceFile, add_common_arguments, apply, drop_managed, finish,
    looks_like_ahura, managed_block, refuse_unmanaged, relative, repo_source,
    strip_comments, walk_sources,
)
...
def main_span(text: str):
    ...
    Not install_common.function_span: that one requires a literal `(void)`, and
