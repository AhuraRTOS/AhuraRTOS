"""
***************************************************************************************************
 * @file        install_stm32_online.py
 * @author      Nima Askari
 * @github      https://github.com/AhuraRTOS/AhuraRTOS
 * @version     1.0.0
 * @date        2026
 * @brief       Install AhuraRTOS into an STM32CubeMX CMake project - one command.
 **************************************************************************************************

Run this from the root of your CubeMX project - the directory holding
CMakeLists.txt and the .ioc. It copies the application-owned files, adds the
CMake block, routes the tick and wires up os_init() / os_start(). It never opens
the .ioc, and every C edit goes inside a CubeMX USER CODE section so regeneration
keeps it. It prints the exact diff first and asks before writing anything.
...
tools/_internal/engine.py, and the stm32-specific half in tools/_internal/stm32.py. Both are
